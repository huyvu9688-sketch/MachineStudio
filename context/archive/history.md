# Archived Progress History (frozen 2026-08-06)

This file is the append-only historical record for Milestones 0-3 and the
early Milestone 4 work. It is **not read during normal work.** Read it only
when you need the reasoning behind a past decision, or when a source-file
comment points at `context/progress-tracker.md` for rationale — that
rationale is here.

Current status, active work, and open decisions live in
`context/progress-tracker.md`. Do not add new entries to this file unless
you are retiring a completed milestone from the tracker.

---

# Part 1 — Master tracker history (was context/progress-tracker.md)
...
# Part 2 — Unit 3 history (was context/progress/unit-3.md)
...
# Part 3 — Unit 4 history (was context/progress/unit-4.md)
