...
// Pinned by `npm run module:source-hash -- ball-screw 0.1.1` — see
...
const EXPECTED_SOURCE_HASH = "29230aede64f91df";

describe("ball-screw 0.1.1 module conformance", () => {
...
describe("ball-screw 0.1.1 boundary and invalid input", () => {
...
describe("ball-screw 0.1.1 outputs", () => {
...
describe("ball-screw 0.1.1 validation record completeness", () => {
