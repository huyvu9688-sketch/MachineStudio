// Generic report schema for the pneumatic-cylinder module. Declares the
// sections a report renders from the stored trace and computation
// (Unit 5.2); it never reimplements formulas.
