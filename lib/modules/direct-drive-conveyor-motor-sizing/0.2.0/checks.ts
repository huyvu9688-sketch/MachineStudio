// Acceptance checks for the direct-drive-conveyor-motor-sizing module.
// Only one real check exists: the inertia ratio against an engineer-
// supplied maximum. Every other torque/speed/power figure is a reported
// required spec, not evaluated pass/fail -- this module takes no candidate
// motor's own rated torque as an input to check against (stage-2-contract.md
// "Decisions" item 4; ADR-0011 "Output scope") -- the same single-check
// shape ball-screw-motor-sizing@0.1.0's own checks.ts already established.
//
