...
// direct-drive-conveyor-motor-sizing 0.2.1` -- see
...
const EXPECTED_SOURCE_HASH = "11e4cf99c014c86b";

describe("direct-drive-conveyor-motor-sizing 0.2.1 module conformance", () => {
...
describe("direct-drive-conveyor-motor-sizing 0.2.1 executeModule", () => {
