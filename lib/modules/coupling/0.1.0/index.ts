// The coupling module package (Unit 4.5). Assembles the manifest, ports,
...
export const couplingModule: ModulePackage = sealModulePackage({
  manifest,
  ports,
  inputSchema,
  compute,
