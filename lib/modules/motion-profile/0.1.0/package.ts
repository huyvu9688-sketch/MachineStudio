// The motion-profile module package (Unit 4.2, Stage 3 draft). Assembles
...
export const motionProfileModule: ModulePackage = sealModulePackage({
  manifest,
  ports,
  inputSchema,
  compute,
...
export default motionProfileModule;
