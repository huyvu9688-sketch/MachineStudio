// Generic report schema for the motion-profile module. Declares the sections
// a report renders from the stored trace and computation (Unit 5.2); it
// never reimplements formulas.
...
export const reportSchema: ModuleReportSchema = {
  sections: [
    ...
    { id: "warnings", title: "Warnings", include: "warnings" },
  ],
};
