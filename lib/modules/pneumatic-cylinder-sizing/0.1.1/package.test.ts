...
const EXPECTED_SOURCE_HASH = "2d1c7a9b830de655";

describe("pneumatic-cylinder-sizing 0.1.1 module conformance", () => {
...
describe("pneumatic-cylinder-sizing 0.1.1 boundary and invalid input", () => {
...
describe("pneumatic-cylinder-sizing 0.1.1 outputs", () => {
