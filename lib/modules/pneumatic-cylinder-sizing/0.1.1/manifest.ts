...
//
// v0.1.1 (this version) is a UI-clarity-only patch on 0.1.0: incline_angle
// (motion.axis.incline_angle, [0, 90] deg) had no help text explaining
// that 0deg = horizontal and 90deg = vertical, and that any value between
// is a real blended orientation, not a horizontal/vertical toggle -- see
// ./ui.ts and validation.ts "deviations". No port, formula, output, or
// catalog-matching behavior changes from 0.1.0.
