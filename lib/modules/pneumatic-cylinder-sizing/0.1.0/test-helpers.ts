// Shared test-only helpers for the pneumatic-cylinder-sizing module test
// files. Mirrors lib/modules/pneumatic-cylinder/0.1.0/test-helpers.ts. Not
// part of the module package itself (never imported by
