...
// 0.3.1` -- see lib/engine/module-sdk/conformance.ts's
...
const EXPECTED_SOURCE_HASH = "4a3236b8054d70ae";

describe("belt-pulley-drive-motor-sizing 0.3.1 module conformance", () => {
...
describe("belt-pulley-drive-motor-sizing 0.3.1 executeModule", () => {
...
describe("belt-pulley-drive-motor-sizing 0.3.1 disabledWhen wiring", () => {
