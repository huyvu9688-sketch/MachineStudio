// Acceptance checks for the belt-pulley-drive-motor-sizing module. Only one
// real check exists in 0.1.0: the inertia ratio against an
// engineer-supplied maximum. Every other torque/speed/power figure is a
// reported required spec, not evaluated pass/fail (stage-1-spec.md
// "Purpose" -- the same single-check shape every Motor Sizing Tool module
// already establishes).
