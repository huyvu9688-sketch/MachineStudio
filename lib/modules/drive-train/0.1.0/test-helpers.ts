// Shared test-only helpers for the drive-train module test files. Not part
// of the module package itself (never imported by manifest/compute/trace/
// checks/ui/report/validation or package.ts). Mirrors
// lib/modules/support-bearing/0.1.0/test-helpers.ts.
