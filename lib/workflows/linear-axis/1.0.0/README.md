...
| `linear-axis.coupling` | `coupling`        | 0-1 — **open product decision**, not yet resolved by the founder: a direct-drive axis may have no separate coupling component. See `context/progress-tracker.md` "Open decisions".                                                                        |
